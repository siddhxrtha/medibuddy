...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function sendAiMessage() {
    ...
    try {
      ...
      // Add AI response immediately (typewriter delay removed for faster UX)
      ...
      aiMsgDiv.querySelector('p').textContent = data.response || 'Sorry, I encountered an error. Please try again.';
